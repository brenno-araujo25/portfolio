export default function About() {
    return (
        <section id="about" className="mt-12">
          ...
          <p className="text-gray-400 leading-relaxed lg:w-1/2">
            ...
            Tenho experiência no desenvolvimento de APIs RESTful, versionamento de código com Git/GitHub e conteinerização com Docker.
            Estou sempre explorando novas tecnologias, pois, acredito que a busca constante por aprendizado é importantíssima para o crescimento profissional.
          </p>
        </section>
    );
}